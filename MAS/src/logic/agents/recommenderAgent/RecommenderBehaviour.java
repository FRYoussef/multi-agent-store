...
public class RecommenderBehaviour extends CyclicBehaviour {
    private static final String CONTENT_BASED_RECOMMENDER = "src" + File.separator + "logic" + File.separator +"agents" 
        + File.separator + "recommenderAgent" + File.separator + "content-based-rocommender.py";
    private static final String COLABORATIVE_FILTER_RECOMMENDER = "src" + File.separator + "logic" + 
        File.separator + "agents" + File.separator + "recommenderAgent" + File.separator + "collaborative-filter-recommender.py";
